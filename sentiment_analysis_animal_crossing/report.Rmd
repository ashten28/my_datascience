...
```{r, include=FALSE}
# rmarkdown::render(paste0(here::here(), '/sentiment_analysis_animal_crossing/report.Rmd'), output_file = paste0(here::here(),'/sentiment_analysis_animal_crossing/README.md'))
```
